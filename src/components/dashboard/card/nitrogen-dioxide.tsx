...
import {
  generateNitrogenDioxideBadge,
  nitrogenDioxide,
} from '@/lib/data/sensor-data/air-quality/nitrogen-dioxide';
...
const NitrogenDioxideCard: FC<NitrogenDioxideCardProps> = ({
  value,
  isLoading,
  className,
}) => {
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-4">
          ...
          {user && (
            <div className="flex justify-center">
              <ExportSensorDialog
                name={nitrogenDioxide.title}
                sensorTypeCode={nitrogenDioxide.sensorTypeCode}
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="flex items-start gap-1 justify-center">
            ...
            <span className="font-semibold text-muted-foreground mt-1">
              {nitrogenDioxide.unit}
            </span>
          </div>
          <div className="flex flex-col items-center gap-3">
            {generateNitrogenDioxideBadge(isLoading ? undefined : value)}
          </div>
        </div>
        <div className="mt-2">
