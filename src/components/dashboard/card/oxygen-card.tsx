...
import { generateOxygenBadge, oxygen } from '@/lib/data/sensor-data/air-quality/oxygen';
            ...
            <CardHeader>
                <div className='flex flex-col lg:flex-row justify-between gap-4'>
                    ...
                    <div className='flex justify-center'>
                        <ExportSensorDialog name={oxygen.title} sensorTypeCode={oxygen.sensorTypeCode} sensorType='air-quality' />
                    </div>
                </div>
            </CardHeader>
            ...
            <CardContent>
                <div className='flex flex-col justify-center items-center gap-2'>
                    <div className='flex items-start gap-1 justify-center'>
                        ...
                        <span className='font-semibold text-muted-foreground mt-1'>{oxygen.unit}</span>
                    </div>
                    <div className='flex flex-col items-center gap-3'>{generateOxygenBadge(isLoading ? undefined : value)}</div>
                </div>
                <div className='mt-2'>
