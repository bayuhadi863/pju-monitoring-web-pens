...
import {
  generatePM10Badge,
  particulateMatter10,
} from '@/lib/data/sensor-data/air-quality/particulate-matter-10';
      ...
      <CardHeader>
        <div className="flex flex-col lg:flex-row justify-between gap-4">
          <div className="flex items-start gap-2">
            <img src={pm10Icon} alt="App Logo" className="w-6 mt-0" />
          ...
          {user && (
            <div className="flex justify-center">
              <ExportSensorDialog
                name={particulateMatter10.title}
                sensorTypeCode={particulateMatter10.sensorTypeCode}
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="flex items-start gap-1 justify-center">
            ...
            <span className="font-semibold text-muted-foreground mt-1">
              {particulateMatter10.unit}
            </span>
          </div>
          <div className="flex flex-col items-center gap-3">
            {generatePM10Badge(isLoading ? undefined : value)}
          </div>
        </div>
        <div className="mt-2">
