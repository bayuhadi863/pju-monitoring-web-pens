...
import {
  generateWindSpeedBadge,
  windSpeed,
} from '@/lib/data/sensor-data/weather/wind-speed';
      ...
      <CardHeader>
        <div className="flex flex-col lg:flex-row justify-between gap-4">
          <div className="flex items-start gap-2">
            <img src={windSpeedIcon} alt="App Logo" className="w-6 mt-0" />
          ...
          {user && (
            <div className="flex justify-center">
              <ExportSensorDialog
                ...
                sensorTypeCode={windSpeed.sensorTypeCode}
                sensorType="weather"
              />
            </div>
          )}
