...
import {
  generatePM25Badge,
  particulateMatter25,
} from '@/lib/data/sensor-data/air-quality/particulate-matter-25';
      ...
      <CardHeader>
        <div className="flex flex-col lg:flex-row justify-between gap-4">
          <div className="flex items-start gap-2">
            <img src={pm25Icon} alt="App Logo" className="w-6 mt-0" />
          ...
          {user && (
            <div className="flex justify-center">
              <ExportSensorDialog
                name={particulateMatter25.title}
                sensorTypeCode={particulateMatter25.sensorTypeCode}
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="flex items-start gap-1 justify-center">
            ...
            <span className="font-semibold text-muted-foreground mt-1">
              {particulateMatter25.unit}
            </span>
          </div>
          <div className="flex flex-col items-center gap-3">
            {generatePM25Badge(isLoading ? undefined : value)}
          </div>
        </div>
        <div className="mt-2">
