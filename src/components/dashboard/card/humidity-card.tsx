...
import {
  generateHumidityBadge,
  humidity,
  humidityGenerateBgColor,
} from '@/lib/data/sensor-data/weather/humidity';
...
const HumidityCard: FC<HumidityCardProps> = ({
  value,
  isLoading,
  className,
}) => {
      ...
      <CardHeader>
        <div className="flex flex-col lg:flex-row justify-between gap-4">
          <div className="flex items-start gap-2">
            <img src={humidityIcon} alt="App Logo" className="w-6 mt-0" />
          ...
          {user && (
            <div className="flex justify-center">
              <ExportSensorDialog
                name={humidity.title}
                sensorTypeCode={humidity.sensorTypeCode}
                sensorType="weather"
              />
            </div>
          )}
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          ...
          <div className="flex flex-col items-center gap-3">
            <Progress
              ...
              className="w-36 h-2"
              indicatorColor={humidityGenerateBgColor(
