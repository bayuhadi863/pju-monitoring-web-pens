...
import {
  generateSulfurDioxideBadge,
  sulfurDioxide,
} from '@/lib/data/sensor-data/air-quality/sulfur-dioxide';
...
const SulfurDioxideCard: FC<SulfurDioxideCardProps> = ({
  value,
  isLoading,
  className,
}) => {
      ...
      <CardHeader>
        <div className="flex flex-col lg:flex-row justify-between gap-4">
          <div className="flex items-start gap-2">
            <img src={sulfurDioxideIcon} alt="App Logo" className="w-6 mt-0" />
          ...
          {user && (
            <div className="flex justify-center">
              <ExportSensorDialog
                name={sulfurDioxide.title}
                sensorTypeCode={sulfurDioxide.sensorTypeCode}
      ...
      <CardContent>
        <div className="flex flex-col justify-center items-center gap-2">
          ...
          <div className="flex flex-col items-center gap-3">
            {generateSulfurDioxideBadge(isLoading ? undefined : value)}
          </div>
        </div>
        <div className="mt-2">
